...
impl MeshData {
    ...
    pub fn clear(&mut self) {
        ...
        self.quads = core::array::from_fn(|_| Vec::new());
    }
}
...
pub fn mesh_chunk(voxels: &[u16], mesh_data: &mut MeshData, transparents: BTreeSet<u16>) {
    // Hidden face culling
    for a in 1..(CS_P - 1) {
        let a_cs_p = a * CS_P;
...
#[inline]
fn get_quad_packed(x: usize, y: usize, z: usize, w: usize, h: usize, v_type: usize) -> u64 {
    ((v_type << 32) | (h << 24) | (w << 18) | (z << 12) | (y << 6) | x) as u64
}
#[inline]
fn get_quad(x: usize, y: usize, z: usize, w: usize, h: usize, v_type: usize) -> Quad {
    Quad {
        x: x as u32,
        y: y as u32,
        z: z as u32,
